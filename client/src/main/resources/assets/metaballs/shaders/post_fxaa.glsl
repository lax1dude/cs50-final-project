...
void main() {
	vec4 posPos;
    posPos.xy = texCoord - (0.6 / screenSize);
    posPos.zw = texCoord + (0.6 / screenSize);
    vec4 rcpFrameOpt;
    ...
    fragOut = vec4(FxaaPixelShader(texCoord, posPos, tex, rcpFrameOpt, rcpFrameOpt2, edgeSharpness, edgeThreshold, edgeThresholdMin).rgb, 1.0);
}
